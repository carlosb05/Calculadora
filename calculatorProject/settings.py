...
SECRET_KEY = 'django-insecure-bc1gs2!mhvkt_ay%a=*!sonlo4v7fx3y+5)2gidc#c^5z65!ri'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES':(
        'rest_framework_simplejwt.authentication.JWTAuthnetication',
    )
}

AUTH_USER_MODEL = 'calculatorApp.User'
